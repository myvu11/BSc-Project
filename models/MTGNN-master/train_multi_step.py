...
parser.add_argument('--save',type=str,default='./save/METR-LA',help='save path')
...
def main(runid):
    ...
    log_train = "log_MTGNN_" + str(args.data).replace("/","_") + "_train.txt"
    ...
    for i in range(1,args.epochs+1):
        ...
        for iter, (x, y) in enumerate(dataloader['train_loader'].get_iterator()):
            ...
            for j in range(args.num_split):
                ...
                tx = trainx[:, :, id.long(), :]
                ty = trainy[:, :, id.long(), :]
                metrics = engine.train(tx, ty[:,0,:,:],id.long())
    ...
    log_test = "log_MTGNN_" + str(args.data).replace("/","_") + "_traintest.txt"
